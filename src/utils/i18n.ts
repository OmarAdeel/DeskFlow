...
export const translations: Record<'en' | 'ar', TranslationKeys> = {
  en: {
    ...
    searchPlaceholder: 'Search Slack workspace...',
    online: 'Online',
    away: 'Away',
    dnd: 'Do Not Disturb',
    ...
    chooseTheme: 'Choose Slack Visual Theme',
  ...
  ar: {
    ...
    aiDigest: 'ملخصات الذكاء الاصطناعي (Slack AI)',
    ...
    searchPlaceholder: 'بحث في مساحة عمل سلاك...',
    online: 'متصل الآن',
    away: 'غائب',
    dnd: 'عدم الإزعاج',
    inMeeting: 'في اجتماع',
    ...
    chooseTheme: 'اختر سمة سلاك (Slack Visual Theme)',
